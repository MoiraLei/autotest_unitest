...
class KeyBoardOperator:
    ...
    def del_some_word_with_backspace(self, locator):
        self.driver.find_element(By.XPATH, locator).send_keys(Keys.BACK_SPACE)
        time.sleep(2.5)
    ...
    def cut_content(self, locator):
        self.driver.find_element(By.XPATH, locator).send_keys(Keys.CONTROL, 'x')
        time.sleep(2)

    # 粘贴内容
    def paste_content(self, locator):
        self.driver.find_element(By.XPATH, locator).send_keys(Keys.CONTROL, 'v')
        time.sleep(2)

    # 回车代替点击操作
    def enter_click(self, locator):
        self.driver.find_element(By.XPATH, locator).send_keys(Keys.ENTER)
        time.sleep(2.5)
