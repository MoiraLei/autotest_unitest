...
class TestBBS(unittest.TestCase):
    ...
    def test_add_fail_case(self):
        ...
        mock_return_data = {"data": [], "errorMsg": "The message is too short,min is 20 character2",
                            "result": False}  # mock数据返回结果
        mock_data = mock.Mock(return_value=mock_return_data)
        print(mock_data)
        ...
        self.assertEqual(res['errorMsg'], "The message is too short,min is 20 character2")
