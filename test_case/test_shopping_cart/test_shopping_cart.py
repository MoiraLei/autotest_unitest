...
class ShoppingCartTest(unittest.TestCase):
    ...
    def test_edit_product(self, mock_opt):
        ...
        #
        # shopping_cart1 = shopping_cart.addProduct(product_name='plush_bear', num=2)
        # print(shopping_cart1)
        mock_opt.return_value = "edit successfully"

        self.assertEqual(ShoppingCart.editProduct(product_name='plush_bear', num=3), 'edit successfully')
